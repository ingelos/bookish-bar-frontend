const categorizedSubjects = {
    ...
    Science: ["biology", "chemistry", "mathematics", "physics", "algebra", "education", "geography",
        "science", "psychology"],
    History: ["ancient civilization", "archaeology", "anthropology", "autobiographies", "history", "women",
        "kings and rulers", "religion", "english language"],
    Business: ["programming", "management", "entrepreneurship", "business economics",
        "business success", "finance", "computer science"]
}

export default categorizedSubjects;
